function toggleMenu() {
  ...
  (function(){
    emailjs.init("9S9wC4W2_ahwMdNcW"); // <-- change this
  })();
  ...
  document.getElementById("contactForm").addEventListener("submit", function(e){
    ...
    emailjs.send("service_gm9akrv","template_0bk8gsn",params);
    emailjs.send("service_gm9akrv","template_amuby6c",params)
    .then(function(){
  ...
  document.getElementById("contactForm").addEventListener("submit", function(e){
    ...
    if(response.length == 0){
      return; // user কিছুই দেখবে না (silent block)
    }
